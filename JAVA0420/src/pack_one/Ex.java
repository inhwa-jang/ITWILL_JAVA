...
//		Random r; // 컴파일 에러 발생!
		...
		/*
		 * pack_two 패키지 아래에 Person 클래스 생성
		 * private 접근제한자를 사용하는 name 멤버변수 정의
		 * name 멤버변수에 대한 Getter/Setter 정의
		 * pack_one 패키지 아래의 Ex.java에서 Person 클래스를 활용하여 인스턴스를 생성
		 * name에 "홍길동"을 입력하고, name을 호출해서 화면에 출력
		 */
